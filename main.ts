...
let 隕石: Sprite = null
let 子彈: Sprite = null
let 太空戰士: Sprite = null
太空戰士 = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . 2 2 2 2 2 e . . . . 
    . . . . . 2 2 2 2 d 2 2 e . . . 
    . . . . e 2 2 2 2 2 2 2 e . . . 
    ...
    . . . . . . f f f f . . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(太空戰士, 0, 100)
太空戰士.setPosition(30, 60)
太空戰士.setFlag(SpriteFlag.StayInScreen, true)
let 太空垃圾 = [
img`
    . . . . c c c b b b b b . . . . 
...
game.onUpdateInterval(1000, function () {
    隕石 = sprites.createProjectileFromSide(太空垃圾[randint(0, 太空垃圾.length - 1)], randint(-60, 0), 0)
    隕石.y = randint(0, scene.screenHeight())
    隕石.setKind(SpriteKind.Enemy)
    statusbar = statusbars.create(15, 2, StatusBarKind.EnemyHealth)
    statusbar.max = 30
    statusbar.setLabel("HP", 3)
    statusbar.setColor(7, 2)
    statusbar.attachToSprite(隕石)
})
